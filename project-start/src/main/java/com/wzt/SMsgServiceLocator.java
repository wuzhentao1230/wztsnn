...
public class SMsgServiceLocator extends org.apache.axis.client.Service implements com.wzt.SMsgService {
    ...
    public com.wzt.SMsg_PortType getSMsg(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wzt.SMsgSoapBindingStub _stub = new com.wzt.SMsgSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wzt.SMsg_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wzt.SMsgSoapBindingStub _stub = new com.wzt.SMsgSoapBindingStub(new java.net.URL(SMsg_address), this);
                _stub.setPortName(getSMsgWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sms.fegroup.com.cn:8096/axis/services/SMsg", "SMsgService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sms.fegroup.com.cn:8096/axis/services/SMsg", "SMsg"));
        }
